...
class StudentApplySearchResultPage extends StatefulWidget{

  final String searchText;
  final bool isHandle;
  StudentApplySearchResultPage(this.searchText,this.isHandle);

  @override
  State<StatefulWidget> createState() => new _ApplySearchResultPage();
}

class _ApplySearchResultPage extends State<StudentApplySearchResultPage>{
