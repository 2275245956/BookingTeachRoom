...
class CheckedApplyStudent extends StatefulWidget {
  CheckedApplyStudent();
...
class _RecordListScreenState extends State<CheckedApplyStudent>
  ...
  void loadData() async {
    ...
    var data = await GetAllApplyedStudentByTeachNum(userInfo.account, pageNum.toString());
