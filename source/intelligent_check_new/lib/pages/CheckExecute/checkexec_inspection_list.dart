...
class _CheckExecInspectionList extends State<CheckExecInspectionList> with AutomaticKeepAliveClientMixin{
                      ...
                      return GestureDetector(
                        ...
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context){
                            return CheckExecInspectionListDetail(this.initConfig,f,_itemResultDataMap,this.widget.pointId,this.widget.planId,this.widget.checkMode);
                          })).then((v){
                            if(v != null){
                              if(v.toString().startsWith("cancel")){
                                  List<String> ids = v.toString().substring(8).split("||");
...
//                                print(_itemResultDataMap);
                                setState(() {
                                  for(var _mKey in v.keys){
                                    ...
                                    if(_itemResultDataMap[_mKey] == null || _itemResultDataMap[_mKey].uniqueKey == null){
