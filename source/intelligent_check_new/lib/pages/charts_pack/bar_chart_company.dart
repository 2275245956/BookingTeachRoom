...
class SimpleBarChartCompany extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  SimpleBarChartCompany(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
//  factory SimpleBarChartCompany.withSampleData() {
//    return new SimpleBarChartCompany(
//      _createSampleData(),
...
class ItemChart4 extends StatefulWidget {
  String activeDate = "今天";

  @override
  _ItemChart4State createState() => _ItemChart4State();
}

class _ItemChart4State extends State<ItemChart4> {
  var total = 0;
  var missed = 0;
  var unfinished = 0;
  var finished = 0;
  ...
  void initState() {
    super.initState();
    getData();
    print('bar_chart_company.getData()');
  }
  ...
  getData() async {
    ...
    setState(() {
      if (dataList != null) {
        ...
        print(dataList["company"].toString());
        total = company["total"];
        missed = company["missed"];
        unfinished = company["unfinished"];
