...
class ItemChart8 extends StatefulWidget {
  @override
  _ItemChart8State createState() => _ItemChart8State();
}

class _ItemChart8State extends State<ItemChart8> {
  var cancel = 0;
  var proccesed = 0;
  var timeout = 0;
  var finished = 0;
