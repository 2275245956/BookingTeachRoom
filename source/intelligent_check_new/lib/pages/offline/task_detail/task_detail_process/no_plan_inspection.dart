...
import 'package:intelligent_check_new/pages/offline/task_detail/task_detail_process/manual_input.dart';
import 'package:intelligent_check_new/pages/offline/task_detail/task_detail_process/nfc_page.dart';
import 'package:intelligent_check_new/pages/offline/task_detail/task_detail_process/qr_page.dart';
...
//  final num taskId;
  ...
  NoPlanInspection(this.task,this.taskModel);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        ...
        controller: _tabController,
        children: <Widget>[
          NfcPage(this.widget.task,this.widget.taskModel),
          QrPage(this.widget.task,this.widget.taskModel),
          ManualInput(this.widget.task,this.widget.taskModel),
        ],
      ),
    );
  }
