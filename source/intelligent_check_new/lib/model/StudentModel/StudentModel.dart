...
class StudentsInfo {
  ...
  StudentsInfo.fromParams({this.attriNumber01, this.attriNumber02, this.attriText02, this.sEmail, this.sId, this.attriText01, this.createDate, this.sMajor, this.sName, this.sNumber, this.sPass, this.sRole, this.updateDate});

  factory StudentsInfo(jsonStr) => jsonStr == null ? null : jsonStr is String ? new StudentsInfo.fromJson(json.decode(jsonStr)) : new StudentsInfo.fromJson(jsonStr);
